...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Zi,depthTest:!1,depthWrite:!1})}function o3(e,t,n){const i=new Float32Array(Ws),s=new D(0,1,0);return new ui({name:"SphericalGaussianBlur",defines:{n:Ws,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Fc(),fragmentShader:`
		...
		`,blending:Zi,depthTest:!1,depthWrite:!1})}function Xf(){return new ui({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Fc(),fragmentShader:`
		...
		`,blending:Zi,depthTest:!1,depthWrite:!1})}function Yf(){return new ui({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Fc(),fragmentShader:`
