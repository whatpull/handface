...
#define LOW_PRECISION`),e}const bM={[rc]:"SHADOWMAP_TYPE_PCF",[Oa]:"SHADOWMAP_TYPE_VSM"};function TM(t){return bM[t.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const AM={[sr]:"ENVMAP_TYPE_CUBE",[Vr]:"ENVMAP_TYPE_CUBE",[Fc]:"ENVMAP_TYPE_CUBE_UV"};function wM(t){return t.envMap===!1?"ENVMAP_TYPE_CUBE":AM[t.envMapMode]||"ENVMAP_TYPE_CUBE"}const CM={[Vr]:"ENVMAP_MODE_REFRACTION"};function RM(t){return t.envMap===!1?"ENVMAP_MODE_REFLECTION":CM[t.envMapMode]||"ENVMAP_MODE_REFLECTION"}const PM={[Du]:"ENVMAP_BLENDING_MULTIPLY",[h1]:"ENVMAP_BLENDING_MIX",[u1]:"ENVMAP_BLENDING_ADD"};function LM(t){return t.envMap===!1?"ENVMAP_BLENDING_NONE":PM[t.combine]||"ENVMAP_BLENDING_NONE"}function IM(t){const e=t.envMapCubeUVHeight;if(e===null)return null;const n=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,n),7*16)),texelHeight:i,maxMip:n}}function DM(t,e,n,i){const s=t.getContext(),r=n.defines;let a=n.vertexShader,o=n.fragmentShader;const c=TM(n),l=wM(n),h=RM(n),d=LM(n),u=IM(n),f=gM(n),g=_M(r),M=s.createProgram();let m,p,S=n.glslVersion?"#version "+n.glslVersion+`
