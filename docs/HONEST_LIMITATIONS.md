...
| **6×6 substrate (N=6 Phase 2A.2)** | ✅ **100% noisy accuracy** — Bottom row 포함 (commit 후속 측정) |
...
| 영역 | 한계 |
|------|------|
| 6×6 substrate "Bottom row" 패턴 (N=8 mock) | ⚠️ 직전 P213 mock 4 시드 학습 실패 (-1) — N=4/5/6 production 시나리오에는 영향 없음 측정 확인 (Bottom row c4 = 100% at N=6) |
